...
moneytex.src = "./tex/money.png";

const carrotSeedHotbar = new Image();
carrotSeedHotbar.src = "./tex/carrotSeedHotbar.png";

const carrotCount = new Image();
carrotCount.src = "./tex/carrotCount.png";

const carrotSeed = new Image();
carrotSeed.src = "./tex/carrotSeed.png";

const stonePath = new Image();
stonePath.src = "./tex/stonePath.png";

const dirt = new Image();
dirt.src = "./tex/dirt.png";

const tilledDirt = new Image();
tilledDirt.src = "./tex/tilledDirt.png";

const carrot = new Image();
carrot.src = "./tex/carrot.png";
